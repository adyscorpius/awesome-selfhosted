...
- [Kibitzr](https://kibitzr.readthedocs.io/en/latest/) - Lightweight personal web assistant with powerful integrations. ([Source Code](https://github.com/kibitzr/kibitzr)) `MIT` `Python`
